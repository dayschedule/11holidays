      ...
      <div className="mx-auto max-w-[900px] space-y-12">
        <div className="space-y-4 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-[700px] mx-auto">
            We provide reliable, up-to-date public holiday data for developers
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                At 11holidays.com, our mission is to make it simple for
                developers and businesses to access accurate public holiday
                information from around the world. We believe that having
                reliable holiday data shouldn&apos;t be complicated or
                expensive.
              </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                ...
                clean documentation, predictable endpoints, and easy
                integration.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                From startups to enterprises, businesses worldwide rely on our
                API for their holiday data needs.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Our team continuously monitors and updates holiday information
                to reflect changes in government schedules and announcements.
              </p>
            </CardContent>
          </Card>
        </div>
